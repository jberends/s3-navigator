...
class TestS3Client(unittest.TestCase):
    ...
    def test_list_buckets(self):
        ...
        mock_response = {
            'Buckets': [
                ...
                {
                    'Name': 'test-bucket-2',
                    'CreationDate': datetime(2021, 2, 1)
                }
            ],
            'Owner': {
    ...
    def test_list_objects(self):
        ...
        with mock.patch.object(self.s3_client.client, 'get_paginator') as mock_paginator:
            ...
            with mock.patch.object(self.s3_client, '_calculate_directory_size', return_value=1000):
        ...
        dir_items = [item for item in objects if item['type'] == 'DIR' and item['name'] != '..']
    ...
    def test_delete_directory(self):
        ...
        with mock.patch.object(self.s3_client.client, 'get_paginator') as mock_paginator:
            ...
            with mock.patch.object(self.s3_client.client, 'delete_objects',
