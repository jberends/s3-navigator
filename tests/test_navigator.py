...
class TestS3Navigator(unittest.TestCase):
    ...
    def test_list_objects(self):
        ...
        mock_objects = [
            ...
            {'name': 'file1.txt', 'type': 'FILE', 'size': 100, 'last_modified': '2023-01-02'},
            {'name': 'folder1', 'type': 'DIR', 'size': 200, 'last_modified': '2023-01-03'}
        ]
    ...
    def test_toggle_selection(self):
        ...
        # Setup test data
        self.navigator.current_items = [
            {'name': 'file1.txt', 'type': 'FILE', 'size': 100, 'last_modified': '2023-01-01'},
            {'name': 'file2.txt', 'type': 'FILE', 'size': 200, 'last_modified': '2023-01-02'}
        ]
        self.navigator.current_path = ['test-bucket']
        self.mock_display_instance.selected_index = 0
    ...
    def test_delete_selected(self):
        ...
        # Setup test data
        self.navigator.selected_items = ['test-bucket/file1.txt', 'test-bucket/folder1/']
        ...
        self.mock_s3_client_instance.delete_object.assert_any_call('test-bucket', 'file1.txt')
        self.mock_s3_client_instance.delete_object.assert_any_call('test-bucket', 'folder1/')
        self.assertEqual(self.navigator.selected_items, [])
    ...
    def test_sort_items(self):
        ...
        # Setup test data
        self.navigator.current_items = [
            {'name': 'b.txt', 'type': 'FILE', 'size': 100, 'last_modified': '2023-01-03'},
            {'name': 'a.txt', 'type': 'FILE', 'size': 300, 'last_modified': '2023-01-01'},
            {'name': 'c.txt', 'type': 'FILE', 'size': 200, 'last_modified': '2023-01-02'}
        ]
